...
player.moveIt = function() {
	...
	if (this.onGround && this.fellFrom != -1) {
...
var testCloud3 = new BoxCloud(-50,1050,-450,150,250,80);//850
...
var testCoin = new Coin(20,1250,-270,30,10,16,50);
testCoin.updateLight([232, 196, 79], [176, 136, 7]);
...
allShapes.push([testCoin.v[0].z,testCoin]);
