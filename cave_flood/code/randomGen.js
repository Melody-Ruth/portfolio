...
function setup() {
	...
	if (randomGen) {
		...
		passages = [newPassage(0,-100+100,150,400,true,true,false,false,[]),newPassage(0,720+100,150,600,true,true,false,false,[]),
			newPassage(0,1740+100,150,680,true,true,false,false,[['l', 2280, 2380]]),newPassage(0,2840+100,150,600,true,true,false,false,[['l',3100,3250]]),
			newPassage(-1500,3580+100,790,150,false,false,true,true,[]),newPassage(-1650,2600+100,100,960,true,true,false,false,[['r',3100,3250]]),
			newPassage(-1550,3100+100,1550,150,false,false,true,true,[]),newPassage(-920,2280+100,920,100,false,false,true,true,[]),
			newPassage(-1650,1000+100,100,1030,true,true,true,false,[['l',1000,1100]]),newPassage(-2300,1000+100,650,100,false,false,true,true,[]),
			...
			newPassage(1815,675+100,936,150,false,false,true,true,[]),newPassage(2751,675+100,150,4000,true,true,false,true,[['l',675,825]]),
