...
function preload() {
	testing = loadImage("../graphics/test_image.png");
	smiley = loadImage("../graphics/smiley.png");
	crystal = loadImage("../graphics/crystal.png");
	crystalGroup = loadImage("../graphics/crystal_group2.png");
	crystalGroupWater = loadImage("../graphics/crystal_group_water.png");
	crystalWater = loadImage("../graphics/crystal_water.png");
	...
	for (var i = 0; i < 10; i++) {
		crystalImages[i] = loadImage("../graphics/crystal_group_water.png"/*, pic => print(pic), loadImgErrFix*/);
	}
	//Load the water crystal images. They each need to load their own so that manipulating one won't affect the others.
	for (var i = 0; i < 10; i++) {
		singleCrystalImages[i] = loadImage("../graphics/crystal_water.png"/*, pic => print(pic), loadImgErrFix*/);
	}
}
...
var ballStartPos = [1070,1230];//Where the ball starts the game
var waterLevel = 1630;//Starting water level
