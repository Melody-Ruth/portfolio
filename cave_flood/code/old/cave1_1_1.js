...
var crystals = [newCrystal(230,400,60,2,-110,0),newCrystal(-30,1390,70,2,-30,1),newCrystal(160,1550,50,2,112,2),
	...
	newCrystal(800,3262,60,2,0,21),newCrystal(580,790,65,1,0,7),newCrystal(520,500,60,2,-90,22),newCrystal(1755,250,70,1,-70,8)];
...
angleMode(DEGREES);
	...
	cutOut(mapCover,floor((-xTranslate+3000)/10),floor((-yTranslate+110)/10),60,60);
	//Put code here
	push();
