function sketchProc(p) {
	...
	var passages = [newPassage(493,250,400,100,false,false,true,true),newPassage(1037,493,100,400,true,true,false,true)];
	...
	p.draw = function() {
		...
		fill(0);
		//ellipse(100-xTranslate,100-yTranslate,50,50);
